...
public class StatusEffectRegistry {
    ...
    public static void register() {
        Registry.register(Registries.STATUS_EFFECT, ResourceIdentifier.get(DeathKnights.MODID, "blood_power"), BLOOD_POWER);
        Registry.register(Registries.STATUS_EFFECT, ResourceIdentifier.get(DeathKnights.MODID, "unholy_power"), UNHOLY_POWER);
    }
}
